...
def playlist_base_id(entry_id: str) -> str:
    """Strip any '@media' directive from a playlist token.

    Public wrapper over `_parse_playlist_entry_id` for callers outside this
    module (routes/panel.py maps the UI's playlist back onto screen slugs).
    """
    return _parse_playlist_entry_id(entry_id)[0]
